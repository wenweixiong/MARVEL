...
#' @export
#' @return An object of class S3 containing all the original slots as inputted by the user in addition to one new slot named \code{$DE$Gene}
...
CompareValues.Exp <- function(MarvelObject, cell.types, n.cells, method, method.adjust) {
