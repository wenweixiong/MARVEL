...
#' @param seed.dts Numeric value.  Only applicable when \code{level} set to \code{"splicing"}. The seed number for the random number generator to ensure reproducibility of DE analysis when \code{method} set to \code{"dts"}. By default this is not specified, i.e., \code{NULL}.
#'
...
CompareValues <- function(MarvelObject, cell.group.g1=NULL, cell.group.g2=NULL, downsample=FALSE, seed=1, min.cells=25, pct.cells=NULL, method=NULL, seed.dts=NULL, nboots=1000, method.adjust="fdr", level, event.type=NULL, show.progress=TRUE, annotate.outliers=TRUE, n.cells.outliers=10, assign.modality=TRUE, custom.gene_ids=NULL, psi.method=NULL, psi.pval=NULL, psi.delta=NULL, method.de.gene=NULL, method.adjust.de.gene=NULL, mast.method="bayesglm", mast.ebayes=TRUE) {
