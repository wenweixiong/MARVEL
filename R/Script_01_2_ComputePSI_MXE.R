...
#' @export
#' @return An object of class S3 containing all the original slots as inputted by the user in addition to two new slots. \code{$SpliceFeatureValidated$MXE} contains the validated splicing event metadata. \code{$PSI$MXE} contains the computed PSI values for the validated splicing events.
...
ComputePSI.MXE <- function(MarvelObject, CoverageThreshold) {
