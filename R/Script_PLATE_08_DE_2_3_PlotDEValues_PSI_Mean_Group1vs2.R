...
PlotDEValues.PSI.Mean.g2vsg1 <- function(MarvelObject, method, pval, delta=5, point.size=1, xlabel.size=8, anno=FALSE, anno.tran_id=NULL, label.size=2.5, point.alpha=1.0, event.types=c("SE", "MXE", "RI", "A5SS", "A3SS", "AFE", "ALE")) {
