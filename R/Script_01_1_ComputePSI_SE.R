...
#'
#' @description \code{ComputePSI.SE} computes percent spliced-in (PSI) skipped-exon (SE) splicing event.
#'
...
#' @export
#' @return An object of class S3 containing all the original slots as inputted by the user in addition to two new slots. \code{$SpliceFeatureValidated$SE} contains the validated splicing event metadata. \code{$PSI$SE} contains the computed PSI values for the validated splicing events.
#' @author Sean Wen <sean.wenwx@gmail.com>
#' @import methods
#' @examples
#' marvel <- readRDS(system.file("extdata/Data", "MarvelObject.rds", package="MARVEL"))
#'
#' marvel <- ComputePSI.SE(MarvelObject=marvel,
...
ComputePSI.SE <- function(MarvelObject, CoverageThreshold) {
