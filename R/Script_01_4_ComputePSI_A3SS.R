...
#' @export
#' @return An object of class S3 containing all the original slots as inputted by the user in addition to two new slots. \code{$SpliceFeatureValidated$A3SS} contains the validated splicing event metadata. \code{$PSI$A3SS} contains the computed PSI values for the validated splicing events.
