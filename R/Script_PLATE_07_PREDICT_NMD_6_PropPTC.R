#' @title Proportion of Transcripts with PTC
#'
#' @description
...
#'
#' @param MarvelObject S3 object generated from \code{FindPTC} function.
...
#' @export
#'
#' @return An object of class S3 containing all the original slots as inputted by the user in addition to one new slot named \code{MarvelObject$NMD$PTC.Prop}.
#'
